    ...
    <div class="form_target box_body">
        ...
        <div class="tx_field1 wd100pc">
            ...
            <div class="input_item">
                <input type="text" name="name" id="name" placeholder="Nama produk" value="" maxlength="100">
            </div>
        </div>
        ...
        <div class="tx_field1 mt1c5">
            ...
            <div class="input_item">
                ...
                <input type="text" name="price" id="price" placeholder="10000" value="" ptx_format="currency">
            </div>
        </div>
        ...
        <div class="tx_field1 mt1c5">
            ...
            <div class="input_item">
                <textarea id="description" name="description" placeholder="Tulis deskripsi singkat" style="min-height: 100px;" maxlength="1000"></textarea>
            </div>
        </div>
                ...
                $.formCollect
                    ...
                    .collect(
                        (json) => {
                            ...
                            let url = $.makeURL.api().addPath('catalog/product').href,
