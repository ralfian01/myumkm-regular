    ...
    <div class="form_target box_body">
        ...
        <div class="tx_field1 wd100pc">
            ...
            <div class="input_item">
                <input type="text" name="name" id="name" placeholder="Nama kategori produk" value="<?= $catalog_category_data['category_name']; ?>">
            </div>
        </div>
        ...
        <div class="tx_field1 mt1c5">
            ...
            <div class="input_item">
                ...
                <input type="text" name="slug" id="slug" placeholder="link_kategori" value="<?= str_replace('product/', '', $catalog_category_data['slug']); ?>">
            </div>
        </div>
