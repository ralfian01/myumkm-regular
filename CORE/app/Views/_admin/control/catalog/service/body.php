                    ...
                    <tr style="<?= $key % 2 == 0 ? 'background: rgba(var(--Col_theme-main3), 0.25);' : ''; ?>">
                        ...
                        <td class="p0c5">
                            <div class="flex y_center h_center mb_flex_col" style="height: 100%;">
                                <a class="button1 bt_small p0" style="--bt_bg: none; --bt_color: rgb(var(--Col_theme-main)); --bt_border_color: none;" href="<?= adminURL("catalog/service/category/edit/{$val['category_id']}"); ?>">
